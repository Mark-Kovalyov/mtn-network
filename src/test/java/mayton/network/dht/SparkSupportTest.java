...
public class SparkSupportTest {
    ...
    void test() {
        ...
        assertEquals(jsonOpt.get(), "{\"a\":{\"id\":\"cf7d361a318552bf4f07f887c1cf90ea111ef8c7\",\"info_hash\":\"cf7d344ea1600a22efadb7ff1b27e9829d3fdcbd\"},\"q\":\"6765745f7065657273 ( 'get_peers' )\",\"t\":\"203b\",\"v\":\"4c540102\",\"y\":\"71 ( 'q' )\"}");
    }
    ...
    void testNonDecodedRealData() {
        ...
        Optional<String> err1 = SparkSupport.dumpDhtMessageToPlainJsonDebug(b1);
        assertTrue(err1.isPresent());
        assertEquals(err1.get(),"DHT:ERR:002:unexpected character 0xCB at offset 0");
    }
